...
def main():
    ...
    if os.path.exists(BATCH_ID_PATH):
        ...
        print("Run stage0_musique_groq_batch_download.py to check status.")
        return
    ...
    batch_file = client.files.create(
        file=("musique_batch_groq.jsonl", io.BytesIO(jsonl_content.encode("utf-8"))),
        purpose="batch",
    )
    ...
    print("Run stage0_musique_groq_batch_download.py when complete.")
